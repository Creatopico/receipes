ServerEvents.recipes(event => { 
    ...
    event.remove({output: 'primalstage:primitive_grill'})
    event.shaped('primalstage:primitive_grill', [
        'AAA',
        'A A',
        'A A'
      ], {
    ...
    event.shaped('minecraft:furnace', [
      ...
      event.remove({output: 'primalstage:cutting_log'})
      event.shaped('primalstage:cutting_log', [
        ' A ',
        ' A ',
        ' A '
      ], {
      ...
      event.shaped('primalstage:salted_pelt', [
        'BA ',
        'AA ',
        '   '
      ], {
        B: 'primalstage:skimmed_pelt',
        A: 'meadow:alpine_salt'
      })
})